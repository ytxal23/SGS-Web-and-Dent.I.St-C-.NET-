...
<head>
  <meta charset="utf-8">
  <title>School Grading System/REPORT/Student Report Card</title>
  ...
  $(document).on("click", ".result p", function(){
    ...
    var h = document.getElementById('hhh').value;
    var xmlhttpreq;
    try
  {
  ...
  try
    ...
    var url= 'table_stud_graderep.php';
    url= url + '?gsheet='+ h;
    //alert(url);
    xmlhttpreq.onreadystatechange=function(){if(this.readyState==4)
        {
             var myObject = JSON.parse(this.responseText);

//alert(myObject);  // Received the data 
var studName=document.getElementById('labelS').textContent;
var str="<thead><tr><th class='hidden-phone' position='center' style='font-style: bold;text-align:center;' background-color='white' colspan='5'>STUDENT RECORDS</th></tr><tr><th class='hidden-phone' style='font-style: bold;' background-color='white' colspan='5'>Name: "+studName+"</th></tr><tr><th class='hidden-phone'>Subject</th><th class='hidden-phone'>Schedule</th><th class='hidden-phone'>Professor</th><th class='hidden-phone'>Grades</th><th class='hidden-phone'>Remarks</th></tr></thead><tbody>";

for(i=0;i<myObject.data.length;i++)
{ 
str = str + "<tr><td class='editable' id='subj'>" + myObject.data[i].subj + "</td><td class='editable' id='tsch'>" + myObject.data[i].tsch + "</td><td class='editable' id='ttch'>" + myObject.data[i].ttch + " </td><td class='editable' id='tgpa'>" + myObject.data[i].tgpa +"</td><td class='editable' id='trem'>" + myObject.data[i].trem+ "</td></tr>"

}
str = str + "</tbody>" ;
document.getElementById("subj-grid").innerHTML=str;
}
}
    xmlhttpreq.open('GET', url, true);
    xmlhttpreq.send();

        document.getElementById('labelS').innerHTML=h;      
    ...
    $user = $_SESSION['user']; echo $role. " " .$user; ?></label></li>
      ...
      <div class="container">
        ...
        <div class="w3-container"> 
            ...
            <input id='hhh' type="text" autocomplete="off" placeholder="Search student.." /><button class="btn btn-primary" onclick="printDiv('printableArea')">Generate PDF</button>
            <div class="result">
        
            </div>
            </div>
            <div class = "Info">
            <label class='hidden' id= "labelS"></label>
            </div>
