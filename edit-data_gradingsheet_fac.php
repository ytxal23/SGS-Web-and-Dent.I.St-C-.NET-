...
$stmt = $con->query("UPDATE tbldetailrecord SET tbldetailrecord.strfkStudent = '".$tstudno."', tbldetailrecord.intMidterm ='".$tmidterm."', tbldetailrecord.intFinal = '".$tfinal."',tbldetailrecord.decFinalGrade = '".$tfinalgrade."', tbldetailrecord.strReqRemarks = '".$tremarks."' WHERE tbldetailrecord.strfkStudent = '".$tstudno."' AND tblheaderrecord.strfkTeacher = '$user';");
...
if($stmt)
{
    ...
    activityLog($strAct);
     ...
     echo '<tr>' .
       ...
       '<td class="editable" id="tgid">'. $_POST['tgid'] . '</td>' .
       '<td class="editable" id="tdetail">'. $_POST['tdetail'] . '</td>' .
