    ...
    $user = $_SESSION['user']; echo $role. " " .$user; ?></label></li>
      ...
      <div class="container">
        ...
        <div class="w3-panel2 w3-blue w3-card-4">
            ...
            <table id = "teacher-grid" class="table table-striped table-style-two" cellpadding="0" cellspacing="0"><thead><tr><th>Subject</th><th>Teacher/Instructor</th><th>Final Grade</th><th>Remarks</th></tr></thead>
                <?php
                require 'table_gradingsheet_stud.php';
                ?>
                </table>
