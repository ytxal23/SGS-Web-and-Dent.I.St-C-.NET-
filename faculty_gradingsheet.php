            ...
            <table id = "teacher-grid" class="table table-striped table-style-two" cellpadding="0" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th class="hidden-phone">##</th>
                  <th class="hidden-phone">Student ID</th>
                  <th class="hidden-phone">Student Name</th>
                  <th class="hidden-phone">Midterm Grade</th>
                  <th class="hidden-phone">Final Grade</th>
                  <th class="hidden-phone">FINAL</th>
              ...
              <tbody>
                <?php
                require 'table_gradingsheet.php';
                ?>
              </tbody>
